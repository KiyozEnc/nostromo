            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        ...
                        <input type="text" class="form-control" name="CBNumber" placeholder="Input..2.">
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-4">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12">
                        ...
                        - le jour de la réservation (<?php echo $_SESSION['Reservation']->getPercentInteret().' supplémentaires'; ?>)
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-sm-12">
