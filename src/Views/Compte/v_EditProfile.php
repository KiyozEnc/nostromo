            ...
            <div class="row row-centered">
                ...
                <div class="col-xs-12 col-md-4 col-centered">
                    <div class="form-group text-center">
                        ...
                        <input name="pwdconf" type="password" class="form-control">
                    </div>
                </div>
            </div>
            <div class="row row-centered">
            ...
            <div class="row row-centered">
                <div class="col-xs-12 col-md-4 col-centered">
                    <div class="form-group text-center">
                        ...
                        <input name="actualpwd" type="password" class="form-control" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-md-6 col-md-offset-2">
                    <a href="?page=monCompte" class="btn btn-default">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-8 col-md-offset-2">
                    <small class="text-justify">
                        Seulement les champs que vous renseignerez serons modifiés.
                        Veuillez indiquer le mot de passe actuel de votre compte pour confirmer.
                        Il vous est impossible de modifier votre adresse e-mail.
                    </small>
                </div>
            </div>
        </form>
