...
<div class="thumbnail">
    <img
        ...
        height="256"
        width="256"
        src="<?php echo $article->getUrl(); ?>"
        title="Article n°<?= $article->getNumArt() ?>">
    <hr>
    <div class="caption">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-md-2 col-md-offset-1">
                    ...
                    <input
                        ...
                        readonly
                        disabled
                        value="<?php echo $article->getPu() ?>">
                </div>
                <div class="col-xs-12 col-md-5">
                    <h3>Prix :
                        <span class="text-info">
                            <?php echo '<span id="priceContainer">'.Build::fEuro($article->getPu()).'</span>'; ?>
                        </span>
                    </h3>
                </div>
            </div>
